...
IMV_TransmissionType = enum(
    transTypeUnicast=0,     #///< \~chinese 单播模式		\~english Unicast Mode
    transTypeMulticast=1    #///< \~chinese 单播模式		\~english Unicast Mode
)
...
_IMV_StreamStatisticsInfo_._fields_ = [
    ('nCameraType', c_uint),
    ('streamStatsInfo', IMV_StreamStatsInfo)
]
...
class _IMV_STransmissionType_(Structure):
    pass
_IMV_STransmissionType_._fields_ = [
    ('eTransmissionType', c_int),
    ('nDesIp', c_uint),
    ('nDesPort', c_ushort),
    ('nReserved', c_uint * 8)
]
IMV_STransmissionType = _IMV_STransmissionType_